...
pub type LockedWal = Arc<ParkingMutex<SerdeWal<OperationWithTimestamp>>>;
...
impl LocalShard {
    ...
    pub async fn new(
        ...
        wal: SerdeWal<OperationWithTimestamp>,
    ...
    pub async fn load(
        ...
        let wal: SerdeWal<OperationWithTimestamp> = SerdeWal::new(
    ...
    pub async fn build(
        ...
        let wal: SerdeWal<OperationWithTimestamp> =
